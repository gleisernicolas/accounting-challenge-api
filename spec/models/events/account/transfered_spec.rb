  ...
  describe '#create' do
    ...
    context '#validations' do
      it 'amount must be positive greater than one integer' do
        expect { described_class.create!(account: source_account, destination_account: destination_account, amount: -1000) }.
    ...
    context 'when source account does not have funds' do
      it 'does not complete the transfer' do
        expect { described_class.create!(account: source_account, destination_account: destination_account, amount: 200_000) }.
